-- 3 Additional practice of the basic features using a table of Nobel Prize winners.
...
-- 3.5 Show all details (yr, subject, winner) of the Literature prize winners
...
-- 3.6 Show all details of the presidential winners: Theodore Roosevelt,
...
-- 3.8 Show the year, subject, and name of Physics winners for 1980 together
...
-- 3.9 Show the year, subject, and name of winners for 1980 excluding
